...
Requester is meant for use apps with Rails API/Any front end framework.

Requester takes the responses/requests from your Rails test suite, and saves them in a JSON file,
which is written to your front end repo.

Why would you want this?

Let's say you've using something like
[pretender](https://github.com/pretenderjs/pretender),
[ember-cli-mirage](https://github.com/samselikoff/ember-cli-mirage), or
or [json-server](https://github.com/typicode/json-server) to intercept HTTP
requests in your front end acceptance tests, and you switched the format of the JSON your api responds with.
Chances are whatever you're using to intercept requests doesn't have a way to format
your fake responses using your custom JSON format, so now your front end app will have a busted suite until you can get all your fake JSON formats converted.
Replace your fake JSON with responses generated by Requester from your Rails app, and import them in your front end tests.

Pretend we have a Rails app with a `DecksController`.
Given this set of (useless) tests:
